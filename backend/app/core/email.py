...
conf = ConnectionConfig(
    ...
    MAIL_FROM_NAME="Prescription AI",      # Add sender name
    MAIL_PORT=587,
    MAIL_SERVER="smtp.gmail.com",
    MAIL_STARTTLS=True,
    MAIL_SSL_TLS=False,
    USE_CREDENTIALS=True,
    VALIDATE_CERTS=True,                   # Add this
)
...
async def send_otp_email(email: EmailStr, otp: str, full_name: str):
    ...
    <div style="font-family: Arial, sans-serif; max-width: 480px; margin: 0 auto; padding: 32px; background: #f9f9f9; border-radius: 12px;">
        <div style="text-align: center; margin-bottom: 24px;">
            <h1 style="color: #6366f1; margin: 0;">Prescription AI 🏥</h1>
        </div>
    ...
    message = MessageSchema(
        subject="Your Prescription AI verification code",
        recipients=[email],
        body=html,
